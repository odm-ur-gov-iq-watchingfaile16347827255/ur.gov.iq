(function () {
    ...
    app.modals.LookupModal.create = function (lookupOptions) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Biller/Common/LookupModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Biller/Views/Common/Modals/_LookupModal.js',
...
(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'Biller/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Biller/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Biller/Views/Common/Modals/_EntityTypeHistoryModal.js',
