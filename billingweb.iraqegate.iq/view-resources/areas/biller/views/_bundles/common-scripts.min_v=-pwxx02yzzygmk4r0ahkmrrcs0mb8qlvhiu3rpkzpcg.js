...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['ETEC.EEP.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                switch (userNotification.notification.notificationName) {
                    case 'App.NewUserRegistered':
                        return '/Biller/users?filterText=' + userNotification.notification.data.properties.emailAddress;
                    case 'App.NewTenantRegistered':
                        return '/Biller/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
                    case "App.NewWorkflowRequest":
                        return '/Biller/WorkflowRequests/Index';
            ...
            var openSettingsModal = function () {
                new app.ModalManager({
                    viewUrl: abp.appPath + 'Biller/Notifications/SettingsModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/Biller/Views/Notifications/_SettingsModal.js',
...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('Biller');
